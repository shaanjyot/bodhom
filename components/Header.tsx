      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <Link
              href="/auth/login"
              className={`hidden lg:flex items-center space-x-1 px-4 py-2 rounded-full transition-all duration-300 ${
                isScrolled 
                  ? 'text-charcoal-500 hover:text-brass-gold hover:bg-cream-100' 
                  : 'text-white/90 hover:text-white hover:bg-white/10'
              }`}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
              ...
              >
                <input
                  ...
                  className={`flex-1 px-4 py-2 rounded-lg border-2 focus:outline-none focus:ring-2 focus:ring-brass-gold ${
                    isScrolled 
                      ? 'bg-white border-cream-200 text-charcoal' 
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-lg font-semibold transition-colors ${
                    isScrolled 
                      ? 'bg-brass-gold text-white hover:bg-primary-dark' 
                      : 'bg-brass-gold text-white hover:bg-primary-dark'
                  }`}
                >
                  Search
