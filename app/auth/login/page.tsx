    ...
    <div className="min-h-screen bg-cream-DEFAULT">
      ...
      <section className="relative bg-charcoal text-white pt-32 pb-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-brass-gold font-medium tracking-widest uppercase mb-4 animate-fade-in">Welcome Back</p>
      ...
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12 -mt-8">
        ...
        <div className="bg-white rounded-2xl shadow-soft-lg p-8 relative z-10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-brass-gold focus:ring-brass-gold border-cream-300 rounded"
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-charcoal-500">
                  Remember me
                </label>
              </div>
              <Link href="/auth/forgot-password" className="text-sm text-brass-gold hover:text-primary-dark font-medium">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-charcoal-500">
            ...
            <Link href="/auth/register" className="text-brass-gold hover:text-primary-dark font-semibold">
              Sign up
            </Link>
          </p>
        </div>
