    ...
    try {
      ...
      if (data.page) {
        setFormData({
          ...
          menu_order: data.page.menu_order || 0,
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-serif font-bold text-charcoal">Edit Page</h1>
          <p className="text-charcoal-400 mt-1">Update page content and settings</p>
        </div>
      </div>
